...
public class VolatileCode_1_5_Z implements VolatileCodeHandle {
	...
	private net.minecraft.server.ItemStack convertItemStack(org.bukkit.inventory.ItemStack item) {
